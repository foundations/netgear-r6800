...
int udp_response_finish (Context *, int );
...
#ifdef IP6_6RD_CE
void ev_udp_maxfd(fd_set *, int *);
void ev_udp_in_check_read(fd_set *);
#endif
...
#ifdef IP6_6RD_CE
int net_mesg_socket (Nia *, int);
int net_stream_socket (Nia *, int);
#else
