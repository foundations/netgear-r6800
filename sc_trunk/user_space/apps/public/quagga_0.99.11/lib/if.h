...
#ifdef __SC_BUILD__
extern struct cmd_element  config_interface_table_cmd;
extern struct cmd_element   config_interface_main_cmd;
extern struct cmd_element   config_interface_shared_cmd;
#endif
