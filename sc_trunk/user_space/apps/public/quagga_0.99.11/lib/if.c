...
DEFUN (config_interface_table, 
       config_interface_table_cmd,
       "interface table TABLENO",
       "Configure target kernel routing table\n"
       "TABLE integer for an interface\n")
{
  struct interface *ifp;
  //struct rip_interface *ri;

  ifp = (struct interface *)vty->index;
  ifp->table = strtol (argv[0], (char**)0, 10);
  return CMD_SUCCESS;
}
DEFUN (config_interface_main, 
       config_interface_main_cmd,
       "interface main",
       "Configure interface works in main\n")
{
  struct interface *ifp;
  //struct rip_interface *ri;
...
DEFUN (config_interface_shared, 
       config_interface_shared_cmd,
       "interface shared",
       "Configure interface works in main\n")
{
  struct interface *ifp;
