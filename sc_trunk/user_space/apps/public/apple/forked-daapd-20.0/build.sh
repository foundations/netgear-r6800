...
CFLAGS_VARS+="-I`pwd`/../../libunistring-0.9.3/build_sc/lib/ -I`pwd`/../../libunistring-0.9.3/lib/ ";
...
#LDFLAGS_VARS+="-L`pwd`/../../sqlite-3.6.22/ -lsqlite3 -L`pwd`/../../../tr_lib/zlib/zlib-1.2.3/ -lz ";
LDFLAGS_VARS+="-L`pwd`/../../sqlite-autoconf-3130000/build_sc/.libs/ -lsqlite3 -L`pwd`/../../../../../libs/public/tr_lib/zlib/zlib-1.2.3/ -lz ";
LDFLAGS_VARS+="-L`pwd`/../../../../../libs/public/libiconv.1.8/lib/ ";
...
ANTLR="`pwd`/../../antlr3/antlr3" CC="$CC_VAR" CFLAGS="$CFLAGS_VARS" CPPFLAGS="$CFLAGS_VARS" LDFLAGS="$LDFLAGS_VARS" ../configure --target=mipsel-linux-uclibc --host=mipsel-linux-uclibc --build=i486-linux-gnu --prefix= --sbindir=/usr/sbin --sysconfdir=/etc --exec-prefix=/usr --sbindir=/usr/sbin --sysconfdir=/etc --datadir=/usr/share --mandir=/usr/man --exec-prefix=/usr\
	--enable-shared \
	--enable-static \
	--enable-itunes 
#	--enable-flac \
