...
struct xtables_match rand_match
= {	.name		= "random",
	.version	= XTABLES_VERSION,
	.family		= NFPROTO_IPV4,
	.size		= XT_ALIGN(sizeof(struct ipt_rand_info)),
	.userspacesize	= XT_ALIGN(sizeof(struct ipt_rand_info)),
	.init		= init,
	.help		= help,
	.parse		= parse,
...
void _init(void)
{
	xtables_register_match(&rand_match);
}
