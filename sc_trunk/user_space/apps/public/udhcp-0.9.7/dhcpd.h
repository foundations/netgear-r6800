...
#ifdef IPV6
#define IP6_6RD_CE_CONFIG_FILE "/tmp/ip6_6rd_ce.conf"
#define DHCP_OPT_HEADER_LEN 2 /* opt_code opt_length(data) data */
#define IP6_6RD_OPT_DATA_MINLEN 22
#endif
