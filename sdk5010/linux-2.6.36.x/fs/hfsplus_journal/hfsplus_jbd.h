...
extern void * __hfsplus_jbd_kmalloc (const char *where, size_t size, gfp_t flags, int retry);
#define hfsplus_jbd_kmalloc(size, flags) \
	__hfsplus_jbd_kmalloc(__FUNCTION__, (size), (flags), hfsplus_jbd_oom_retry)
#define hfsplus_jbd_rep_kmalloc(size, flags) \
	__hfsplus_jbd_kmalloc(__FUNCTION__, (size), (flags), 1)
...
#define HFSPLUS_JBD_ASSERTIONS
#ifdef HFSPLUS_JBD_ASSERTIONS
#define HFSPLUS_J_ASSERT(assert)						\
do {									\
	if (!(assert)) {						\
		printk (KERN_EMERG					\
...
#else
#define HFSPLUS_J_ASSERT(assert)	do { } while (0)
#endif		/* HFSPLUS_JBD_ASSERTIONS */
...
/**
 * struct hfsplus_jbd_handle_s - The hfsplus_jbd_handle_s type is the concrete type associated with
 *     hfsplus_jbd_handle_t.
...
/* The hfsplus_transaction_t type is the guts of the journaling mechanism.  It
...
/**
 * struct hfsplus_jbd_s - The hfsplus_jbd_s type is the concrete type associated with
 *     hfsplus_jbd_t.
...
/* Filing buffers */
extern void __hfsplus_jbd_temp_unlink_buffer(struct hfsplus_jbd_head *jh);
...
int hfsplus_jbd_next_log_block(hfsplus_jbd_t *, unsigned long *);
...
void __hfsplus_jbd_remove_checkpoint(struct hfsplus_jbd_head *);
...
extern int	 hfsplus_jbd_invalidatepage(hfsplus_jbd_t *,
...
extern void	   hfsplus_jbd_destroy    (hfsplus_jbd_t *);
...
extern int	   hfsplus_jbd_bmap(hfsplus_jbd_t *, unsigned long, unsigned long *);
...
extern void	   hfsplus_jbd_write_revoke_records(hfsplus_jbd_t *, hfsplus_transaction_t *);

/* Recovery revoke support */
extern int	hfsplus_jbd_set_revoke(hfsplus_jbd_t *, unsigned long, hfsplus_jbd_tid_t);
extern int	hfsplus_jbd_test_revoke(hfsplus_jbd_t *, unsigned long, hfsplus_jbd_tid_t);
