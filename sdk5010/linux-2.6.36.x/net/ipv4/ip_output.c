...
//sc add sc_priority
unsigned int (*sc_l3_hook_prifun)(struct sk_buff *skb);

void register_sc_l3_pri_hook(unsigned int *fun)
{
    sc_l3_hook_prifun = fun;
}
void unregister_sc_l3_pri_hook(unsigned int *fun)
{
    sc_l3_hook_prifun = NULL;
}
#endif
...
#ifdef CONFIG_SCM_SUPPORT
    //sc add sc_priority
    if(sc_l3_hook_prifun)
        sc_l3_hook_prifun(skb);
#endif
...
#ifdef CONFIG_SCM_SUPPORT
//sc add sc_priority
EXPORT_SYMBOL(sc_l3_hook_prifun);
EXPORT_SYMBOL(register_sc_l3_pri_hook);
EXPORT_SYMBOL(unregister_sc_l3_pri_hook);
#endif
