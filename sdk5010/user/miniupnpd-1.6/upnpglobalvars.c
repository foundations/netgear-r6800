...
char model_name[DEVICENAME_MAX_LEN] = "";
char model_description[MODELDESCIPRTION_MAX_LEN] = "";
char wlan_friendly_name[FRIENDLY_NAME_MAX_LEN] = "";
char wlan_model_name[DEVICENAME_MAX_LEN] = "";
char wlan_model_num[MODELNUMBER_MAX_LEN] = "";
#endif
