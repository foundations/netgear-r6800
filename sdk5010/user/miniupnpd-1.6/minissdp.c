/* $Id: //WIFI_SOC/MP/SDK_5_0_0_0/RT288x_SDK/source/user/miniupnpd-1.6/minissdp.c#1 $ */
/* MiniUPnP project
                  ...
                  const char * host, unsigned short port)
{
	...
	if (port == WPS_PORT)
	{
		...
		l = snprintf(buf, sizeof(buf), "HTTP/1.1 200 OK\r\n"
			...
			"LOCATION: http://%s:%u" WFA_ROOTDESC_PATH "\r\n"
			"\r\n",
			st_len, st, suffix,
			wps_uuidvalue, st_len, st, suffix,
